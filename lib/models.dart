class Coin {
  ...
  factory Coin.fromJson(Map<String, dynamic> json) {
    return Coin(
      ...
      priceChange24Percentaje: json['market_data']['price_change_percentage_24h'].toDouble(),
    );
  }
}
...
class CoinMarketInfo {
  ...
  factory CoinMarketInfo.fromJson(Map<String, dynamic> json) {
    return CoinMarketInfo(
      marketCap: getJsonFieldSafe<double>(json['market_data']['market_cap'], 'usd', 0.0),
      marketCapRank: getJsonFieldSafe<int>(json['market_data'], 'market_cap_rank', 0),
      tradingVolume24H: getJsonFieldSafe<double>(json['market_data']['total_volume'], 'usd', 0.0),
      circulatingSupply: getJsonFieldSafe<double>(json['market_data'], 'circulating_supply', 0.0),
      totalSupply: getJsonFieldSafe<double>(json['market_data'], 'total_supply', 0.0),
      maxSupply: getJsonFieldSafe<double>(json['market_data'], 'max_supply', 0.0),
    );
  }
}
